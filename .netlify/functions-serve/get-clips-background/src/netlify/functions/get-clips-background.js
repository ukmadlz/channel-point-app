...
// netlify/functions/get-clips-background.mjs
var get_clips_background_exports = {};
__export(get_clips_background_exports, {
  handler: () => handler
});
...
// lib/initSupabase.js
var import_supabase_js = __toESM(require_main7());
var supabase = (0, import_supabase_js.createClient)(process.env.NEXT_PUBLIC_SUPABASE_URL, process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY);
...
module.exports = __toCommonJS(get_clips_background_exports);
...
//# sourceMappingURL=get-clips-background.js.map
